...
const renderWeatherDisplay = ((doc) => {
    ...
    const _renderCurrentWeather = (currentDatas) => {
        ...
        todayDateTime.textContent = format(date, 'cccc d LLLL y HH:mm');
        currentWeatherIcon.src = `https://openweathermap.org/img/wn/${currentDatas.iconCode}@4x.png`;
        ...
        getUnsplashImg
            ...
            .catch((err) => {
                console.log('renderCurrentWeather', err);
            });
        // console.log('renderCurrentWeather', currentDatas);
    };
    ...
    const _renderHourlyWeather = (hourlyDatas) => {
        ...
        hourlyWeatherLis.forEach((li, i) => {
            ...
            hourlyWeatherHour.textContent = `${format(hour, 'HH')}h`;
            hourlyWeatherIcon.src = `https://openweathermap.org/img/wn/${hourlyDatas[i].iconCode}@2x.png`;
        ...
        // console.log('renderHourlyWeather', hourlyDatas);
    };
    ...
    const _renderDailyWeather = (dailyDatas) => {
        ...
        dailyWeatherLis.forEach((li, i) => {
            ...
            dailyWeatherIcon.src = `https://openweathermap.org/img/wn/${dailyDatas[i].iconCode}@2x.png`;
        ...
        // console.log('renderDailyWeather', dailyDatas);
    };
